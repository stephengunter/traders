<template>
   <v-layout row wrap>
      ...
      <v-flex sm12 class="cn">
         ...
         <ul>
            <li>
               10:30:00 ~ 10:31:00 台指期『多方量』的口數 = 給定時間內所有評分為1的單量總和. 例如612 
            </li>
            <li>
               10:30:00 ~ 10:31:00 『多方量』的筆數 = 給定時間內所有評分為1的資料筆數. 例如398 
            </li>
            <li>
               11:12:00 ~ 11:13:00 台指期『空方量』的口數 = 給定時間內所有評分為-1的單量總和. 例如737 
            </li>
            <li>
               11:12:00 ~ 11:13:00 『空方量』的筆數 = 給定時間內所有評分為-1的資料筆數. 例如515 
            </li>
         </ul>
      </v-flex>
   </v-layout>
